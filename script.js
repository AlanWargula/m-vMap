...
class App {
    ...
    constructor() {
        ...
        // removePopupBtn.addEventListener('click', this._deleteWorkout.bind(this));
    }
    ...
    _newWorkout(e) {
        ...
        if (type === 'running') {
            ...
            // check if data is valid or break
    ...
    _renderWorkoutMarker(workout) {
        ...
        removePopupBtn.forEach(el => el.style.display = 'none');
    }
    ...
    _deleteWorkout(e) {
        const workoutEl = e.target.closest('.leaflet-popup-close-button');
